...
PROMPT_TEMPLATE: dict[UserType, dict] = {
    ...
    "system": (
        ...
        "FORMAT:\n"
        "**Place Name**\n"
        "What it is and why it's worth visiting. Best time to go and one practical tip.\n"
        "\n"
        "Repeat for each place. Add a one-line closing tip about the destination overall.\n"
    ),
    "input_prefix": "User:",
...
class ContextBuilder:
    ...
    def build(
        ...
        for msg in previous_chats:
            ...
            result.append({"role": role, "content": content})  # ← THE FIX
